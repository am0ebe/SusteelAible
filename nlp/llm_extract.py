"""
LLM Extraction Pipeline for Company Decarbonisation Report Analysis
===================================================================
...
class Config:
    ...
    # Approach
    approach: Literal["exhaustive", "rag"] = "exhaustive"
    ...
    # RAG-specific (only used when approach="rag")
    top_k: int = 20
...
class ExtractPipeline:
    ...
    def __init__(self, config: Config):
        ...
        print(f"✓ Pipeline initialized ({self.gpu})")
